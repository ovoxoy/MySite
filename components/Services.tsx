            ...
            >
              ...
              <div className="mt-auto">
                {service.type === 'projects' && service.links ? (
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.links.map((link, i) => (
                        <a 
                          ...
                          className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg text-xs font-medium transition-all border border-slate-700 hover:border-slate-600"
                        >
                          {link.label}
                  ...
                  <a href="#contact" className="flex items-center text-xs font-bold text-indigo-400 uppercase tracking-wider group-hover:text-indigo-300 transition-colors">
