  ...
  return (
    <section id="services" className="py-24 md:py-32 bg-slate-950 relative border-t border-white/5 scroll-mt-20">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-px bg-slate-800 rounded-lg overflow-hidden">
          <div className="p-8 flex flex-col items-center text-center bg-slate-900/20 hover:bg-slate-900/40 transition-colors">
